    ...
    <div className="aboutUsPage">
      ...
      <div className="values">
        <div className="valuesCard">
          <h2>Iskustvo</h2>
          <p>
            Krenuli smo u ovu avanturu prije pet godina, od doma, iz Bjelovara,
            sa dva video kreatora s malim YouTube kanalom i velikim snovima.
            Xniks2x i Leo Valentić tada su krenuli snimati za mreže na kanalu
            Live Your Dreams (sada su vam oni veliki snovi jasniji, zar ne?).
          </p>
        </div>
        <div className="valuesCard">
          <h2>Individualnost</h2>
          <p>
